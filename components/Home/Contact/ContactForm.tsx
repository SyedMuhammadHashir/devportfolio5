...
const ContactForm =() =>{
    ...
    <h1  className="text-bg txth1white text-2xl md:text-3xl lg:text-[2.5rem] font-bold">
      Let's work together!
    </h1>
        ...
        <div>
            <select className="w-full mt-5 bg-black text-white placeholder:text-gray-600 px-4 py-3.5 rounded-md
                border-[1.5px] border-gray-200 border-opacity-15 outline-none">
                    ...
                    <option value="frontend">Short Course</option>
                    <option value="backend">Diploma</option>
