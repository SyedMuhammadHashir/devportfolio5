...
const MobileNav = ({closeNav,showNav}:Props) => {
  ...
  return <div>
     ...
     {/* Nav Links */}
            <div className={`text-white ${navOpen} transform transition-all duration-500 delay-300 fixed justify-center flex flex-col h-full w-[80%] sm:w-[60%] space-y-6 z-[10000] bg-[#0f0715]`}>
